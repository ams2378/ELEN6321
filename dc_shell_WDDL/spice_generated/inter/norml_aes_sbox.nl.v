...
NAND2X1TS U1698 ( .A(n3164), .B(n2654), .Y(d0) );
...
NAND2X1TS U1719 ( .A(n2655), .B(n2673), .Y(d2) );
...
NAND2X1TS U1739 ( .A(n3164), .B(n2692), .Y(d3) );
...
NAND2X1TS U2304 ( .A(n2961), .B(n2962), .Y(d6) );
...
NAND2X1TS U2322 ( .A(n3026), .B(n3027), .Y(d5) );
...
NAND2X1TS U2341 ( .A(n3060), .B(n3061), .Y(d4) );
...
NAND2X1TS U2368 ( .A(n2914), .B(n2915), .Y(d7) );
...
NAND2X1TS U2537 ( .A(n3060), .B(n3269), .Y(d1) );
